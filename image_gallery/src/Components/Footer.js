      ...
      <footer className="text-gray-600 bg-gray-100 body-font">
        <div className="container px-5 py-1 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            <Link to="/facebook" className="text-blue-500">
              <svg
                fill="currentColor"
            ...
            <Link to="/twitter"  className="ml-3 text-blue-500">
              <svg
                fill="currentColor"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            <Link to="/instagram"  className="ml-3 text-pink-500">
              <svg
                fill="none"
                stroke="currentColor"
                stroke-linecap="round"
            ...
            <Link to="/linkedin"  className="ml-3 text-blue-500">
              <svg
                fill="currentColor"
                stroke="currentColor"
                stroke-linecap="round"
